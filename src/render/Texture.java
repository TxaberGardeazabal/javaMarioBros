...
public class Texture {
    ...
    public void init(String filePath) {
        ...
        IntBuffer intWidth = BufferUtils.createIntBuffer(1);
        IntBuffer intHeight = BufferUtils.createIntBuffer(1);
        IntBuffer channels = BufferUtils.createIntBuffer(1);
        
        stbi_set_flip_vertically_on_load(true);
        ByteBuffer image = stbi_load(filepath, intWidth, intHeight, channels, 0);
        
        if (image != null) {
            this.width = intWidth.get(0);
            this.height = intHeight.get(0);
            
            switch (channels.get(0)) {
                case 3:
                    glTexImage2D(GL_TEXTURE_2D, 0,GL_RGB, intWidth.get(0), intHeight.get(0), 0, GL_RGB, GL_UNSIGNED_BYTE, image);
                    break;
                case 4:
